...
export const HOTSPOTS = {
  ...
  tv:                 { position: { x: -6.3, y: 2.75, z: 0   }, target: { x: -7.814,  y: 2.75, z: 0 }, label: 'TV', duration: 1.1 },
  ...
  'seat-sofa':          { position: { x: -5.5, y: 1.1,  z: 0   }, target: { x: -7.9,  y: 2.2, z: 0 }, label: 'Sitting on sofa', duration: 0.8 }
};
