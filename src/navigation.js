...
export const HOTSPOTS = {
  ...
  pedestal:       { position: { x: -4.0, y: 1.8, z: -7.0 }, target: { x: -6.5, y: 2.0, z: -9.0 }, label: 'Magic Tome' },
  'rabbit-hole':  { position: { x: -0.2, y: 1.2, z: -1.5 }, target: { x: -0.8, y: 0.2, z: -2.4 }, label: 'Rabbit Hole' },
  tv:                 { position: { x: -5.6, y: 2.05, z: 0   }, target: { x: -7.814,  y: 2.05, z: 0 }, label: 'TV', duration: 1.1 },
  ...
  screen:               { position: { x: 2.0,  y: 1.6,  z: -7.5  }, target: { x: 2.0, y: 1.5, z: -9.5  }, label: 'Screen' },
  'seat-sofa':          { position: { x: -4.0, y: 1.1,  z: 0   }, target: { x: -7.9,  y: 2.05, z: 0 }, label: 'Sitting on sofa', duration: 0.8 }
};
